...
const teams = [
    {
        ...
        roster: [
            ...
            { number: 9, name: "GUILLERMO FELIX", birthDate: "", category: "LOCAL" },
            { number: 10, name: "ELIER SOMBRA", birthDate: "", category: "LOCAL" },
            { number: 11, name: "RAMON RAMIREZ", birthDate: "", category: "LOCAL" },
            { number: 12, name: "RENE MOROYOQUI", birthDate: "", category: "LOCAL" },
            { number: 13, name: "PABLO GIL", birthDate: "", category: "LOCAL" },
            { number: 14, name: "HEYDEN GIL", birthDate: "", category: "LOCAL" },
            { number: 15, name: "ANGEL OSORIO", birthDate: "", category: "LOCAL" },
            { number: 16, name: "RAMON ALBERTO YOCUPICIO", birthDate: "", category: "LOCAL" },
            { number: 17, name: "FELICIANO SOMBRA", birthDate: "", category: "LOCAL" },
            { number: 18, name: "GUSTAVO ESCALANTE", birthDate: "", category: "LOCAL" },
            { number: 19, name: "JOSE YOCUPICIO", birthDate: "", category: "LOCAL" },
            { number: 20, name: "FERNANDO VERDUGO", birthDate: "", category: "LOCAL" },
            { number: 21, name: "ERICK MENDIVIL", birthDate: "", category: "LOCAL" }
        ],
        staff: {
